...
import random
import math
from esha.esha_generator import SceneConfig, ESHAGenerator
from esha.esha_helpers import split_items_into_receptacles_and_objects
...
class ESHAController:
    ...
    def generate_candidate(self, scene_config: SceneConfig) -> Dict[str, Any]:
        """
        Generate a single-room scene candidate using LEGENT's ESHAGenerator.
        """
        odb = self.odb
        ...
        generator = ESHAGenerator(scene_config, odb)
    ...
    def _lock_scene(self, env: Environment, action: Action) -> None:
        self._locked_scene = self._deepcopy_scene(self._current_scene)
    ...
    def _deepcopy_scene(self, scene: Dict[str, Any]) -> Dict[str, Any]:
