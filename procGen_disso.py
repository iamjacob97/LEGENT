from LEGENT.legent import Environment, ResetInfo, generate_scene
from LEGENT.legent import Environment, Observation, generate_scene, ResetInfo, get_mesh_size, load_json
import random
import os

path_to_data_folder = "D:/Dissertation/LEGENT_REPO/Downloads/procthor_assets"
...
def create_scene_with_procthor_objects():
    scene = generate_scene(room_num=3)
